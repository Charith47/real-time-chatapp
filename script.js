...
function setImage(ID){
    ...
    style.innerHTML = '#room-picture{background-image:url(https://robohash.org/' + ID + '/?size=65x65);}' 
...
function appendMessage(name,message){
    ...
    messageElement.innerHTML= "<b>" + name + '</b> <span style="color:rgb(223, 201, 8); font-size:17px;">|</span> ' + message + " " + '<span style="color:rgb(170, 170, 170); font-size:10px;">' + getTime() + "</span>";
...
function myMessage(message){
    ...
    messageElement.innerHTML = message + " " + '<span style="color:rgb(170, 170, 170); font-size:10px;">' + getTime() + "</span>";
    messageContainer.append(messageElement);
...
socket.on('user-count',count=>{
    // display user count 
    if(count > 1) document.getElementById('room-participants').innerHTML = count + " people are online";
    else document.getElementById('room-participants').innerHTML = "You are all alone, find some friends";
})
